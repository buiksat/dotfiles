...
alias net='nautilus . &'
alias nat='nautilus . &'
alias x11vnc='x11vnc -safer -forever -usepw -display :0'
alias update='sudo apt update --yes && sudo apt upgrade --yes &&  sudo apt dist-upgrade --yes && sudo apt autoremove --yes && sudo snap refresh'
